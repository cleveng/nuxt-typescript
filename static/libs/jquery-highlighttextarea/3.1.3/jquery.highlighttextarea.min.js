...
!(function(a) {
  ...
  var b = function(a) {
    ...
    c = function(b, e) {
      ;(this.settings = a.extend({}, c.DEFAULTS)),
        (this.scrollbarWidth = d.getScrollbarWidth()),
        (this.isInput = 'input' == b[0].tagName.toLowerCase()),
        (this.active = !1),
        (this.matches = []),
        (this.$el = b),
        ...
        this.$main.prepend(
          '<div class="highlightTextarea-container"><div class="highlightTextarea-highlighter"></div></div>'
        ),
        (this.$container = this.$main.children().first()),
        (this.$highlighter = this.$container.children()),
        this.setOptions(e),
        this.settings.id && (this.$main[0].id = this.settings.id),
        this.settings.resizable && this.applyResizable(),
        this.updateCss(),
        this.bindEvents(),
        this.highlight()
    }
  ;(c.DEFAULTS = {
    ...
    (c.prototype.highlight = function() {
      ...
      var e = []
      if (
        (a.each(this.settings.words, function(d, f) {
            ...
            a.each(h, function(a, c) {
              e.push(c),
                -1 === i.indexOf(c) &&
                  ((b = b.replace(
                    new RegExp(c, 'g'),
                    '<mark style="background-color:' + d + ';">$&</mark>',
                    'g'
                  )),
                  i.push(c))
            })
        ...
        a.each(this.settings.ranges, function(a, c) {
          if (c.start < b.length) {
            ...
            null != c['class'] && (e += 'class="' + c['class'] + '"'),
              (e += '>'),
              (b = d.strInsert(b, c.start, e))
          }
        }),
    ...
    (c.prototype.setWords = function(a) {
      this.setOptions({ words: a, ranges: {} })
    }),
    (c.prototype.setRanges = function(a) {
      this.setOptions({ words: {}, ranges: a })
    }),
    ...
    (c.prototype.destroy = function() {
      this.disable(),
        d.cloneCss(this.$container, this.$el, [
          'background-image',
          'background-color',
          'background-position',
          'background-repeat',
    ...
    (c.prototype.setOptions = function(b) {
      'object' != typeof b ||
        ...
        a.isEmptyObject(this.settings.words)
          ? a.isEmptyObject(this.settings.ranges) ||
            ((this.settings.words = {}),
            (this.settings.ranges = d.cleanRanges(this.settings.ranges, this.settings.color)))
          : ((this.settings.words = d.cleanWords(this.settings.words, this.settings.color)),
            (this.settings.ranges = {})),
        this.settings.debug ? this.$main.addClass('debug') : this.$main.removeClass('debug'),
    ...
    (c.prototype.bindEvents = function() {
      if (!this.active) {
        ...
        this.$highlighter.bind({
          ...
          this.$el.bind({
            'input.highlightTextarea': d.throttle(
              function() {
                this.highlight()
              },
              100,
            ...
            'resize.highlightTextarea': d.throttle(
              function() {
            ...
            'scroll.highlightTextarea select.highlightTextarea': d.throttle(
              function() {
    ...
    (c.prototype.updateCss = function() {
      d.cloneCss(this.$el, this.$main, ['float', 'vertical-align']),
        this.$main.css({ width: this.$el.outerWidth(!0), height: this.$el.outerHeight(!0) }),
        d.cloneCss(this.$el, this.$container, [
          'background-image',
          'background-color',
          'background-position',
          'background-repeat',
        ...
        d.cloneCss(this.$el, this.$highlighter, [
          'font-size',
          'font-family',
          'font-style',
          'font-weight',
    ...
    (c.prototype.updateSizePosition = function(a) {
      ...
      this.isInput
        ? (b = 99999)
        : (('scroll' == this.$el.css('overflow') ||
            'scroll' == this.$el.css('overflow-y') ||
            ('hidden' != this.$el.css('overflow') &&
              'hidden' != this.$el.css('overflow-y') &&
              this.$el[0].clientHeight < this.$el[0].scrollHeight)) &&
            (c = this.scrollbarWidth),
          (b = this.$el.width() - c)),
  ...
  ;(d.getScrollbarWidth = function() {
    var b = a('<div style="width:50px;height:50px;overflow:auto"><div>&nbsp;</div></div>').appendTo(
        'body'
      ),
      c = b.children(),
    ...
    (d.toPx = function(b) {
      if (b != b.replace('em', '')) {
        var c = a(
          '<div style="font-size:1em;margin:0;padding:0;height:auto;line-height:1;border:0;">&nbsp;</div>'
        ).appendTo('body')
      ...
      return function() {
        function e() {
          return (
            ...
            c
              ? a.apply(c, Array.prototype.slice.call(g))
              : a.apply(h, Array.prototype.slice.call(g))
          )
        }
    ...
    (d.cleanWords = function(b, c) {
      ...
      for (var f = 0, g = b.length; g > f; f++) {
        ...
        if (a.isPlainObject(h)) {
          ...
          for (var i = 0, j = h.words.length; j > i; i++)
            e[h.color].push(d.htmlEntities(h.words[i]))
    ...
    (d.cleanRanges = function(c, d) {
      ...
      for (var f = 0, g = c.length; g > f; f++) {
        var h = c[f]
        if (a.isArray(h)) e.push({ color: d, start: h[0], end: h[1] })
        else if (h.ranges) {
          ;(a.isPlainObject(h.ranges) || b(h.ranges[0])) && (h.ranges = [h.ranges])
          for (var i = 0, j = h.ranges.length; j > i; i++)
            a.isArray(h.ranges[i])
              ? e.push({
                  color: h.color,
                  class: h['class'],
                  start: h.ranges[i][0],
              ...
              : (h.ranges[i].length && (h.ranges[i].end = h.ranges[i].start + h.ranges[i].length),
                e.push(h.ranges[i]))
      ...
      return (
        a.each(e, function(b, c) {
          c.start >= c.end && a.error('Invalid range end/start'),
            c.start < k && a.error('Ranges overlap'),
            (k = c.end)
        }),
        e.reverse(),
        e
    ...
    (a.fn.highlightTextarea = function(b) {
      ...
      return this.each(function() {
        var e = a(this),
          ...
          g = 'object' == typeof b && b
        ;(f || 'destroy' != b) &&
          (f || ((f = new c(e, g)), e.data('highlighter', f)),
          'string' == typeof b && f[b].apply(f, Array.prototype.slice.call(d, 1)))
      })
    })
